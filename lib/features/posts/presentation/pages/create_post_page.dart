  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<AuthBloc, AuthState, String?>(
      ...
      builder: (context, userId) {
        if (userId == null) {
          // The router already handled authentication.
          // This null state is a temporary race condition while AuthBloc updates.
          // Just show a loader until the selector re-runs with the userId.
          return Scaffold(
